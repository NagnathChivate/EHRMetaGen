...
const Dashboard = () => {
  const patients = [
    {
      account: "22718",
      name: "Test 1, Reconcile Tea",
      address: "SCHENFCTADY, NY M4S 1C8",
    },
    {
      account: "23163",
      name: "Test 29556, TS1 NAJ HAUJ",
      address: "SCHENECTADY, NY 12345-5555",
    },
    {
      account: "223804",
      name: "Test Ap1, Patient1 Great Neck1",
      address: "New York, NY 10101",
    },
    {
      account: "23572",
      name: "Test Calim, Test Pat",
  ...
  const messages = [
    {
      name: "PDF, EDIT1",
      subject: "Bad Phone Number",
      from: "Portal",
      date: "09/30/2025",
    },
    {
      name: "Duderino,",
      subject: "Patient Does Not Want texts",
      from: "Portal",
      date: "09/29/2025",
    },
    {
  ...
  const visits = [
    {
      ...
      diagnosis: "-----",
      apptType: "-----",
      date: "09/30/2025 03:29 PM",
    },
    {
      name: "Emma, Watson T",
      diagnosis: "-----",
      apptType: "-----",
      date: "09/30/2025 02:47 PM",
    },
    {
      name: "Madhumala, ECRfile2",
      diagnosis: "10 previous pregnanci",
      apptType: "-----",
      date: "09/30/2025 02:17 PM",
    },
    {
      name: "Header 1, Footer 1",
      diagnosis: "-----",
      apptType: "10mins Both",
      date: "09/29/2025 08:11 AM",
    },
    {
      name: "Husband, John",
      diagnosis: "-----",
      apptType: "-----",
      date: "09/29/2025 07:39 AM",
    },
  ];
  ...
  const documentData = [
    {
      name: "Emma, Watson T",
      docType: "Questionnaire Result",
      queue: "Doctorslump",
      date: "09/29/2025",
    },
    {
      name: "Emma, Watson T",
      docType: "Patient Sign Header",
      queue: "Doctorslump",
      date: "09/29/2025",
    },
    {
      name: "Emma, Watson T",
      docType: "U1 with sign",
      queue: "Doctorslump",
      date: "09/29/2025",
    },
    {
              ...
              {filtered.map((p) => (
                <tr
                  ...
                  className={`patient-row ${
                    highlighted === p.account ? "highlighted" : ""
                  }`}
          ...
          <div className="hospital-card-header d-flex justify-content-between align-items-center">
            ...
            <div>
              ...
              <label className="text-white">
                <input type="checkbox" className="form-check-input me-1" /> Show
                unread only
              </label>
            </div>
          </div>
